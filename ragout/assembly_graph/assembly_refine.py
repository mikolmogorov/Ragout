...
def refine_scaffolds(graph_file, scaffolds):
    ...
    new_scaffolds = _insert_from_graph_experement(graph_file, scaffolds,
                                                  max_path_len)
...
def _get_unigue_path_experiment(graph, prev_cont, next_cont, max_path_len,
                                ordered_contigs):
    src, dst =  str(prev_cont), str(next_cont)
    ...
    paths = list(my_all_simple_paths(graph, src, dst, ordered_contigs,
                                     max_path_len))
